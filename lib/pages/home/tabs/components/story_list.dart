import 'package:safechat/data/user.dart';
import 'package:safechat/models/story/story.dart';
import 'package:safechat/models/user/user.dart';
import 'package:safechat/pages/home/tabs/components/story_widget.dart';
    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return InkWell(
              onTap: () =>
                  Navigator.pushNamed(context, '/story', arguments: user),
              child: StoryWidget(
